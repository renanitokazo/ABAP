* ------------------------------------------------------------------*
*	Program   : Z_DEPENDENCY_INJECTION
*	Objective : This is an ABAP project example demonstrating the use of interfaces,
*             classes, unit testing, dependecy injection and MVC Pattern.
* Author    : Renan Itokazo
*------------------------------------------------------------------*
REPORT z_dependency_injection.
